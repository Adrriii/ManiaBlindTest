	...
	return (<>
		{
			...
			<div className={`${styles.score_thumb} ${highlight ? styles.score_highlight : ''}`}>
				...
				<div className={styles.score_grade}><img src={`/grades/${Score.getGradeImage(Score.getScoreGrade(score_full.score))}.png`} alt={Score.getScoreGrade(score_full.score)}/></div>
				{
					mode === 'song' &&
